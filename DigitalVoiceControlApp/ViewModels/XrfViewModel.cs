...
public class XrfViewModel : ViewModelBase
{

    public ICommand ClearLastHeardCommand { get; }

    public ObservableCollection<LastHeardItemXrf> LastHeard { get; } = [];
    ...
    public void ConsumeXrfData(DStarSessionContext state)
    {
        Dispatcher.UIThread.Post(() =>
        {
            ...
            else
            {
                ...
                var newItem = new LastHeardItemXrf(Dst, Gw, Src, "");
